...
| _slide           | bool                        | Whether the block is sliding.                            |
| _vs_slope        | float                       | Shear wave velocity of the slope during analysis.        |
| _omega           | float                       | Angular frequency.                                       |
| _damp_imp        | float                       | Impedance damping.                                       |
| _damp_tot        | float                       | Total damping.                                           |
