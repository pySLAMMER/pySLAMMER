...
## Try pySLAMMER in your browser

No install needed — the [interactive demo](examples/interactive.qmd) runs entirely in your browser.

[Open in molab](https://molab.marimo.io/github/pySLAMMER/pySLAMMER/blob/main/notebooks/pyslammer_demo.py/wasm?show-code=false){.btn .btn-primary role="button"}
:::
...
Arnold, L., & Garcia-Rivas, D. (2025). Pyslammer (Version v0.2.2) [Python]. Zenodo. [https://doi.org/10.5281/zenodo.15385355](https://doi.org/10.5281/zenodo.15385355)

**Software paper:**

Arnold, L., & Garcia-Rivas, D. (2026). pySLAMMER: a Python package for Seismic LAndslide Movement Modeled using Earthquake Records. *SoftwareX*, 34, 102599. [https://doi.org/10.1016/j.softx.2026.102599](https://doi.org/10.1016/j.softx.2026.102599)
