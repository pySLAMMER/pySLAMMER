...
### DECOUPLED Method:
used this code for decoupled sliding (I think consistent with Chopra Table 5.4.1 Newmark integration with linear acceleration)
```
self.block_disp[curr] = (
               self.block_disp[prev]
               - self.block_vel[prev] * self.dt
               - (excess_acc / 3 + delta_hea / 6) * self.dt**2
           )
```
- Normal: R² = 0.999999 ✅, slope = 1.000857 ✅, intercept = 0.028 ✅
- Inverse: R² = 0.999999 ✅, slope = 1.001143 ✅, intercept = 0.021 ✅
- Combined: 97.7% ✅ individual pass rate
### COUPLED Method:
