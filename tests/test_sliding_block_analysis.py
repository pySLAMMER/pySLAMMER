...
class TestSlidingBlockAnalysis:
    ...
    def test_scale_factor_application(self, sample_ground_motion):
        ...
        ky = 0.1
        scale_factor = 2.0
        sba = SlidingBlockAnalysis(ky=ky, ground_motion=sample_ground_motion, scale_factor=scale_factor)
    ...
    def test_target_pga_scaling(self, sample_ground_motion):
        ...
        sba = SlidingBlockAnalysis(ky=ky, ground_motion=sample_ground_motion, target_pga=target_pga)
    ...
    def test_both_scale_factor_and_target_pga_error(self, sample_ground_motion):
        ...
        with pytest.raises(ValueError, match="Both target_pga and scale_factor cannot be provided"):
    ...
    def test_negative_ky_error(self, sample_ground_motion):
        ...
        ky = -0.1
        with pytest.raises(ValueError, match=f"Yield acceleration ky must be positive, got {ky}"):
    ...
    def test_invalid_ground_motion_type(self):
        ...
        with pytest.raises(TypeError, match="ground_motion must be GroundMotion object or dict"):
    ...
    def test_input_motion_copying(self, sample_ground_motion):
        ...
        sba = SlidingBlockAnalysis(ky=0.1, ground_motion=sample_ground_motion, scale_factor=2.0)
